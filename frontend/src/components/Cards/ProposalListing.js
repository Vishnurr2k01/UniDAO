...
function ProposalListing({key,proposal}) {
  ...
  return (
    ...
    <div className='text-white bg-[#0c1427] rounded-md grid grid-cols-6 text-center p-4 py-8 text-lg mt-6'>
        ...
        {new Date().getTime() > Number(proposal.duration + '000')?<button style={ {
border:'1px solid #00df9a'}} className='py-1 px-2 font-semibold rounded-md text-[#00df9a] hover:bg-[#00df9a] hover:text-white' onClick={()=>setShowModalchart(true)}>View Results</button>: <button style={ {
