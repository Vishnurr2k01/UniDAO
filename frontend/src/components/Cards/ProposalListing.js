...
border:'1px solid #00df9a'}} className='py-1 px-2 font-semibold rounded-md text-[#00df9a] hover:bg-[#00df9a] hover:text-white' onClick={()=>setShowModalvote(true)}>Vote Now</button></div>

    </div>
    <Modalvote isVisible={showModalvote} onClose={()=>setShowModalvote(false)} />
    </>
  );
}
